...
void QDiscord::getGuildMemberAcquired(QByteArray barray)
{
  qDebug() << "";
  qDebug() << this << barray << " getGuildMemberAcquired";
}

void QDiscord::getGuildAcquired(QByteArray barray)
{
  qDebug() << "";
  qDebug() << this << barray << " getGuildAcquired";
}

void QDiscord::getGuildMemberFailed(QNetworkReply::NetworkError er)
{
  qDebug() << "getGuildMemberFailed";
  qDebug() << this << er;
}
