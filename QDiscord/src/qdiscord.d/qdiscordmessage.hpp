...
public:
    ...
    ///\brief Returns embed object
    QSharedPointer<QDiscordEmbed> embed() const
    {
        return _embed;
    }
    ///\brief Returns attachment object
    QSharedPointer<QDiscordAttachment> attachment() const
    {
        return _attachment;
    }
...
private:
    ...
    QSharedPointer<QDiscordAttachment> _attachment;
};
